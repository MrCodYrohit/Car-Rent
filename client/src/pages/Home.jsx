    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl'>
         <span className='text-slate-500'>Wheel's Way: Premium</span>
          <br />
          Rentals and Sales for the Modern Traveler.
        </h1>
        <div className='text-gray-400 text-xs sm:text-sm'>
          Wheel's Way is the best place to find your next perfect Car to
          drive.
          <br />
